...
public class ContextManager {
	protected static List<LocationDetails> cityInfo;
	protected static Integer currentWeather;
	...
	protected static LinkedHashMap<String, User> users = new LinkedHashMap<>();
	...
	protected static void iniPreferenceWorker() {
	...
	protected static void iniLocationMapper() {
	...
	protected static void iniWeatherAlarmWorker() {
	...
	protected static List<LocationDetails> readCityInfo() {
	...
	protected static List<String> getLocationsByService(String service) {
		List<String> result = new ArrayList<>();
		for (LocationDetails locationDetails : cityInfo) {
	...
	protected static void resetClock(String username) {
	...
	protected static boolean checkapoReached(User user) {
		return user.clock == user.apoThreshhold;
	}

	protected static boolean checkTempReached(User user) {
	...
	protected static Integer calculateapoThreshhold(User user) {
